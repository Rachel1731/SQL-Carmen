...
-- Clue #1: Find the least populated country in Southern Europe
...
WHERE co.Name = 'Italy'
 ...
 -- Clue #5: Find a similar-sounding city in South America, not ending with 'an'
...
-- Clue #6: Get the capital city of the country Carmen is in
...
-- Clue #7: Possible next destination (large Spanish-speaking country outside South America)
